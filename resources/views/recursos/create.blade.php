...
<div class="container mt-4">
    ...
    <form action="{{ isset($recurso) 
        ? route('recursos.update', ['proyecto' => $proyecto->id, 'recurso' => $recurso->id]) 
        : route('recursos.store', ['proyecto' => $proyecto->id]) }}" 
        method="POST">
        ...
        <a href="{{ route('recursos.index', ['proyecto' => $proyecto->id]) }}" class="btn btn-secondary">Cancelar</a>
    </form>
</div>
@endsection